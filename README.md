...
This is a exploratory project to make use of big data techniques to process a large set of documents and search for relevant documents given certain query.
